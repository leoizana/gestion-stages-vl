        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainmenu">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item"><a href="./etudiant/rapport.php" class="nav-link">Rédiger</a></li>
                    <li class="nav-item"><a href="./etudiant/conventions.php" class="nav-link">Conventions</a></li>
                </ul><br>
                <?php
